...
class Cell:
    def __init__(self,  x = 0, y = 0, bomb = False, vis = False, flagged = False, hood = 0):
        self.bomb = bomb
        self.visible = vis
...
hexagon = [[Hexagon(0, 0, 0) for i in range(CELLSX)] for j in range(CELLSY)]  
menu = Menu()
reset = Button("reset")
gameTimer = Timer()
